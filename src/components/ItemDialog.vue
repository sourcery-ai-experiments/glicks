        ...
        >
          ...
          >
            ...
            >
              ...
              <div class="mt-4 grid grid-rows-2 items-center">
              ...
              <div class="flex items-center justify-start">
                <p v-for="(category, index) in item.description.category" :key="index" class="text-sm text-gray-500 bg-gray-300 w-min h-min px-1 py-0.5 m-2 rounded-md flex items-center">
                  {{ category }}
                </p>
              </div>
            </DialogPanel>
